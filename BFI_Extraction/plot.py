#Creates single chart, one angle?
...
#
#     if v.ndim == 4:
#         v = v[:, :, :, 0]  # remove receiver
#
#     if v.ndim != 3:
#         print("Skipping unexpected shape:", v.shape)
#         continue
#
#     v = np.abs(v)  # fix complex values
#
...
#
#     angle_labels = [f'Angle {i+1}' for i in range(num_angles)]
#
...
#         plt.plot(x, v[t, :, :], linewidth=0.6, alpha=0.6, color='black')
#     plt.title('Transmitter 1', fontsize=10)
